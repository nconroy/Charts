<?php
	...
	class Chart {
		...
		public function render() {
			...
			$file     = $this->sufix ? __DIR__ . "/Templates/$this->library.$this->type.$this->sufix.php" : __DIR__ .
			                                                                                                "/Templates/$this->library.$this->type.php";
			...
			if (file_exists($file)) {
				...
				$img_url   = file_exists(public_path() .
				                         '/vendor/consoletvs/charts/error.png') ? asset('/vendor/consoletvs/charts/error.png') : 'http://www.iconsfind.com/wp-content/uploads/2015/12/20151208_56663ed552e5d.png';
